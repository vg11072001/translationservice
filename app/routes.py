...
class TranslationRequest(BaseModel):
    text: str = Field(
        ..., max_length=1000, description="Text to be translated"
    )
    target_language: str = Field(
        ...,
        min_length=2,
        max_length=5,
        description="Target ISO language code (e.g., 'hi', 'en')",
    )
...
def translate_get(
    ...
    if len(text) > 1000:
        ...
        translated_chunks = [
            translate_text(chunk, target_language) for chunk in chunks
        ]
